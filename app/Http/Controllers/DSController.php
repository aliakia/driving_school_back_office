...
class DSController extends Controller
{
    ...
    public function createNewDs(Request $request) {
        ...
        DB::transaction(function () use ($request, $filePaths) {
            // Insert into tb_ds
            $dsId = DB::table('tb_ds')->insert([
            ...
            DB::table('tb_settings')->insert([
                "ds_code" => $request['ds_code'],
                "validity_theoretical" => $request["validity_theoretical"],
                "validity_practical" => $request["validity_practical"],
                "validity_dep_cde" => $request["validity_dep_cde"],
                "validity_dep_drc" => $request["validity_dep_drc"],
                "lto_fee_theoretical" => $request["lto_fee_theoretical"],
                "lto_fee_practical" => $request["lto_fee_practical"],
                "lto_fee_dep_cde" => $request["lto_fee_dep_cde"],
                "lto_fee_dep_drc" => $request["lto_fee_dep_drc"],
                "cdbs_fee_theoretical" => $request["cdbs_fee_theoretical"],
                "cdbs_fee_practical" => $request["cdbs_fee_practical"],
                "cdbs_fee_dep_cde" => $request["cdbs_fee_dep_cde"],
                "cdbs_fee_dep_drc" => $request["cdbs_fee_dep_drc"],
                "it_fee_theoretical" => $request["it_fee_theoretical"],
                "it_fee_practical" => $request["it_fee_practical"],
                "it_fee_dep_cde" => $request["it_fee_dep_cde"],
                "it_fee_dep_drc" => $request["it_fee_dep_drc"],
                "others_fee_theoretical" => $request["others_fee_theoretical"],
                "others_fee_practical" => $request["others_fee_practical"],
                "others_fee_dep_cde" => $request["others_fee_dep_cde"],
                "others_fee_dep_drc" => $request["others_fee_dep_drc"],
                "mc_daily_upload_limit" => $request["mc_daily_upload_limit"],
                "lv_daily_upload_limit" => $request["lv_daily_upload_limit"],
                "weekly_upload_limit" => $request["weekly_upload_limit"],
                "seating_capacity" => $request["seating_capacity"],
                "accredited_classroom_count" => $request["accredited_classroom"],
                "percentage_allowable_seating_capacity" => $request["percentage_allowable_seating_capacity"],
                "number_unique_classes_per_days_per_tdc" => $request["number_unique_classes_per_days_per_tdc"],
                "number_unique_classes_per_days_per_dep" => $request["number_unique_classes_per_days_per_dep"],
                "number_prescribed_days_per_instruction" => $request["number_prescribed_days_per_instruction"],
            ]);
        });
    ...
    public function updateDs(Request $request, $ds_code) 
    {
        ...
        DB::transaction(function () use ($request, $ds_code) {
            DB::table('tb_ds')
            ...
            DB::table('tb_settings')
                ->where('ds_code', $ds_code)
                    ->update([
                        ...
                        "accredited_classroom_count" => $request->input('accredited_classroom'),
