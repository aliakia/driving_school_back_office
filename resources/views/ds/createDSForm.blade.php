...
@section('content')
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="bs-stepper wizard-icons wizard-icons-example mt-2" id="wizard-validation">
                ...
                <div class="bs-stepper-content">
                    <form method="POST" action="{{ route('submitDS') }}" id="wizard-validation-form">
                        @csrf
                        ...
                        <div id="ds-details-validation" class="content">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-xl-3 form-password-toggle">
